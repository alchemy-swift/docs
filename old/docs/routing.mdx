...
_Note_ an `EventLoopFuture<T>` is the Swift server world's version of a future. See [Under the Hood](../getting-started/12_underthehood.md).
...
_Next page:_ [_Routing: Middleware_](3b_routingmiddleware.md)
